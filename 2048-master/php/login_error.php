...
<html>
	<head>
		<title> 2048 | Errore Autenticazione </title>
		<meta charset="utf-8"> 
	                            ...
	                            <div class="Column C2">
	                            	<form name="login_form" action="../php/verifica_login.php" method="post" onsubmit="return required()" style="background-color: rgb(87%, 87%, 87%); border-radius: 18px;">
										...
										<p><label> Email: </label> <br> 
											<input name="email" placeholder="Indirizzo Email" type="text"></p>
										<p><label> Password: </label><br>	
											<input name="password" placeholder="Password" type="password"></p>
											<p style="color: red; font-size: 18px; margin-top: 5px; margin-bottom: 5px;">L'indirizzo email o la password inserite sono errate.</p>
										<br><p> <input type="submit" class="btn" value="Accedi"></input></p><br>
									</form>
	                            </div>
