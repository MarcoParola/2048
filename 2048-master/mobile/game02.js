	...
	// FUNZIONE PER L'INSERIMENTO DI UN 2 IN UNA POSIZIONE RANDOM
		...
		function begin(_userId){
            ...
            if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
				...
				document.getElementById("grid").setAttribute("style", "width: "+a + "; height: "+ (a-100) + "px;");
				document.getElementById("schermata").setAttribute("style", "height: "+ a + "px;");

				document.getElementById("casella4").setAttribute("style", "width: 32%;");

				var b = document.getElementById("casella4").offsetWidth;
				
				for(var i=3; i<12; i++)
					document.getElementById("casella" + i).setAttribute("style", "width: 32%; height: " + b + "px; font-size: " + b/2 + "px;");
		...
		function cronometro(){
			...
			if(minuti == 1){
				...
				secondi = 0;
				minuti = 0;
				document.location.href = "./2048aTempo.html";
				return;
